...
library(qrcode)
png("figs/tue23.png")
qr_code("https://martigso.github.io/st_isv23/tue23") |>
  plot()
dev.off()
```
...
jgs_activity |>
  mutate(mins = as.numeric(speech_length_secs) %/% 60,
         ...
         min_sec = ifelse(str_detect(min_sec, "^0min"),
                          str_c(secs, "sek."),
                          min_sec),
         Date = as.Date(speech_start_time),
         speech_start_time = str_sub(speech_start_time, 12, nchar(speech_start_time))) |>
...
## Connecting parts {auto-animate="true" }
...
└── https://data.stortinget.no/eksport/stortingsperioder
    └── MPs in a period
        ...
        └── /eksport/representanter?stortingsperiodeid=2005-2009
...
└── https://data.stortinget.no/eksport/stortingsperioder
    └── MPs in a period
        ...
        └── /eksport/representanter?stortingsperiodeid=2005-2009
            ...
            │   └── /eksport/person?personid=GHB
            └── MP biography
                └── /eksport/kodetbiografi?personid=EIGE
...
└── https://data.stortinget.no/eksport/stortingsperioder
    └── MPs in a period
        ...
        └── /eksport/representanter?stortingsperiodeid=2005-2009
            ...
            │   └── /eksport/kodetbiografi?personid=EIGE
            └── MP picture
                └── /eksport/personbilde?personid=ALYS
